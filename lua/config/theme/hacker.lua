...
H.setup = function()
    ...
    -- SpaceVim TabLine
    hl(0, "SpaceVim_tabline_a", { fg = P.colors.fg_lualine_highlight, bg = P.colors.bg_lualine_highlight})
    hl(0, "SpaceVim_tabline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_m", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_m_i", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_a_SpaceVim_tabline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_b_SpaceVim_tabline_a", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_m_SpaceVim_tabline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_b_SpaceVim_tabline_m", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_m_SpaceVim_tabline_a", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_tabline_a_SpaceVim_tabline_m", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })

    -- SpaceVim StatusLine
    -- m: modified, a: current, b: other, c: command mode
    hl(0, "SpaceVim_statusline_a", { fg = P.colors.fg_lualine_highlight, bg = P.colors.bg_lualine_highlight})
    hl(0, "SpaceVim_statusline_a_bold", { fg = P.colors.fg_lualine_highlight, bg = P.colors.bg_lualine_highlight})
    hl(0, "SpaceVim_statusline_ia", { fg = P.colors.fg_lualine_insert_highlight, bg = P.colors.bg_lualine_insert_highlight})
    hl(0, "SpaceVim_statusline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_c", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_z", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_error", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_warn", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_info", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_hint", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_a_SpaceVim_statusline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_b_SpaceVim_statusline_a", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_a_bold_SpaceVim_statusline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_ia_SpaceVim_statusline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_b_SpaceVim_statusline_ia", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_b_SpaceVim_statusline_c", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_c_SpaceVim_statusline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_b_SpaceVim_statusline_z", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_z_SpaceVim_statusline_b", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_c_SpaceVim_statusline_z", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
    hl(0, "SpaceVim_statusline_z_SpaceVim_statusline_c", { fg = P.colors.fg_lualine_inactive, bg = P.colors.bg_lualine_inactive })
